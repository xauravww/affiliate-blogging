      ...
      {loading ? (
        ...
        <div className="bg-[#F2F2F2]">
          {showCustomBar && (ProductUrl || CurrentPrice || OldPrice) && (
            <div className="custom-bar-overlay fixed w-full bg-white h-28 flex justify-end gap-10 items-center pr-8 top-0 z-10">
          ...
          <div className="flex justify-center w-full flex-col mt-3  rounded-md bg-[#F2F2F2] px-5 pb-5 lg:flex-row">
            <Helmet>
              <title>{ProductTitle}</title>
              <meta name="description" content={ProductAbout} />
            </Helmet>
            <div className="item-wrapper w-full flex flex-col gap-2 rounded-md p-5 bg-white lg:max-w-[50vw] lg:min-w-[50vw]">
              <div className="item flex justify-between">
                ...
                />
                <div className="title-price-wrapper-outer w-full px-6">
              ...
              {ProductUrl && (
                <button
                  className="btn rounded-md bg-[#ffa500] px-6 py-2 w-full text-white lg:hidden"
                  onClick={handleRedirect}
                >
                  BUY IT NOW
                </button>
            ...
            <div className="category-container my-5">
              ...
              <div className="flex flex-wrap gap-2 max-w-[70%] overflow-y-scroll px-7 py-0">
                {category.map((cat, index) => (
                  <span
                    key={index}
                    className="category-box px-3 py-1 bg-blue-600 text-white rounded-lg shadow-md"
                  >
                    {cat}
                  </span>
                ))}
